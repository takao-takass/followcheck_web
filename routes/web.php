...
Route::get('/followcheck/show_user/remove_list/{user_id}','ShowByUserController@indexRemove')->name('show_user.index.remove');
Route::post('/followcheck/show_user/remove/{user_id}','ShowByUserController@removeTweet')->name('show_user.remove');
