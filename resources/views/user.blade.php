            ...
            <div style="margin-bottom:1em">
                <div class="card shadow-sm" style="width:100%;height:100%;">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">- - - - - - - - - - -</h6>
                        <a class='mt-2' href="https://twitter.com/{{$user->disp_name}}" target="_blank" rel="noopener noreferrer"><input type="button" class="btn btn-primary form-control" value="Twitter"/></a>
                        <br/>
                        <a class='mt-2' href="{{ route('gallery.user', ['user_id' => $user->user_id]) }}"><input type="button" class="btn btn-secondary form-control" value="ギャラリー" /></a>
                    </div>
                </div>
            </div>
        </div>
